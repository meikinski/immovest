...
faq:
  - question: "Was ist der Cashflow einer Immobilie?"
    answer: "Der Cashflow einer Immobilie ist der monatliche Überschuss oder das Defizit nach Abzug aller Ausgaben von den Mieteinnahmen. Er ergibt sich aus: Kaltmiete minus laufende Kosten (Hausgeld, Instandhaltung, Leerstand) minus Kapitaldienst (Kredit)."
  - question: "Wie berechne ich den Cashflow einer Immobilie?"
    answer: "Formel: Cashflow = Netto-Mieteinnahmen − laufende Kosten − Kapitaldienst. Netto-Mieteinnahmen = Kaltmiete minus nicht umlagefähige Nebenkosten und Leerstandsrücklage. Kapitaldienst = monatliche Bankrate (Zins + Tilgung)."
  - question: "Was ist ein guter Cashflow bei einer Immobilie?"
    answer: "Ein positiver Cashflow bedeutet, die Immobilie trägt sich selbst und wirft etwas ab. In Großstädten ist oft ±0 realistisch; in Mittelstädten sind +100 bis +150 € möglich. Ein leicht negativer Cashflow ist kein Dealbreaker, wenn Wertsteigerung oder Steuervorteile ihn ausgleichen."
  - question: "Welche Kosten werden beim Cashflow abgezogen?"
    answer: "Nicht umlagefähige Nebenkosten (Hausverwaltung, WEG-Rücklage), Leerstandsrücklage (5–8% der Jahresmiete), Instandhaltungskosten sowie der Kapitaldienst (Zins + Tilgung). Steuern und AfA werden separat berechnet."
  - question: "Was bedeutet negativer Cashflow bei einer Immobilie?"
    answer: "Negativer Cashflow bedeutet, du zahlst monatlich drauf. Das ist nicht automatisch schlecht — wenn Wertsteigerung oder Steuervorteile (AfA) die Differenz überwiegen. Kritisch wird es, wenn der negative Cashflow deine Liquidität dauerhaft belastet."
  - question: "Was ist der Kaufpreisfaktor bei Immobilien?"
    answer: "Der Kaufpreisfaktor (Mietmultiple) = Kaufpreis ÷ Jahreskaltmiete. Unter 20 gilt als cashflow-freundlich, 20–25 ist marktüblich, über 30 schwer positiv zu rechnen ohne hohes Eigenkapital."
---
