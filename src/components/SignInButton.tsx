...
/**
 * Sign-in button that only shows when user is not signed in
 * Renders nothing after hydration if user is already signed in
 */
export function SignInButton() {
  ...
  // Show button during SSR and initial render (for SEO and immediate UX)
  if (!mounted) {
    return (
      <Link
        href="/sign-in"
